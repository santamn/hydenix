...
hydenix = {
  ...
  nix.enable = config.hydenix.enable; # Enable nix module
  sddm.enable = config.hydenix.enable; # Enable sddm module
  system.enable = config.hydenix.enable; # Enable system module
